 ...
 * @author w7
 */
public class GetValuesOfSoldProduct extends JFrame
{	
    /**
     * 
     * @param fieldname
     * @param fieldvalue
     */
    public GetValuesOfSoldProduct(String fieldname,String fieldvalue) 
	{
             setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
		Vector header=new Vector();//for table header
		Vector records=new Vector(); //for inner vector
		Connection con=DBinfo.getConn();
		String query="select * from sales where "+fieldname+"=?";
		try
		{
