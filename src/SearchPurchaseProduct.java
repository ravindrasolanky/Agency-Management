 ...
 * @author Sir
 */
public class SearchPurchaseProduct extends javax.swing.JFrame {

    String itemname,itemvalue;
    /** Creates new form SearchBy */
    public SearchPurchaseProduct() {
        initComponents();
       ...
       // choice1.add("Select");
        ...
        choice1.add("company");
        choice1.add("price");
        choice1.add("quantity");
         choice1.add("seller");
        choice1.add("productId");
    ...
    private void choice1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_choice1ItemStateChanged
        ...
        GetValuesOfPurchase obj=new GetValuesOfPurchase(itemname,itemvalue);
        obj.setVisible(true);
        }
