 ...
 * @author w7
 */
public class DisplayAllPurchasedProduct extends JFrame
{	
    /**
     * 
     ...
     */
    public DisplayAllPurchasedProduct() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException 
	{ setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
          UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
		Vector header=new Vector();//for table header
		Vector records=new Vector(); //for inner vector
		Connection con=DBinfo.getConn();
		String query="select * from purchase order by name";
		try
		{
