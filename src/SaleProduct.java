...
Vector dealer=null;
    ...
    public SaleProduct() {
          dealer=GetValuesFromDB.getDealer();
                     //   jComboBox1.setModel(new DefaultComboBoxModel(sel));
        initComponents();
         jTextField10.setText(""+new Date());
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(gpower.GpowerApp.class).getContext().getResourceMap(SaleProduct.class);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(dealer));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        float price=Float.parseFloat(jTextField6.getText());
         float discount=Float.parseFloat(jTextField8.getText());
          String dealer=(String)jComboBox1.getSelectedItem();
          int quantityUpdate=Integer.parseInt(quanB)-quantity;
   String query1="update product set quantity=? where productId=?";     
        ...
        try
        {
            ...
            ps.setFloat(6,price);
             ps.setString(7,dealer);
              ps.setFloat(8,total);
               ps.setFloat(9,discount);
                ps.setFloat(10,payment);
       ...
       if(i==0)
       {
           JOptionPane.showMessageDialog(this, "Product Can't Sold", "Error", JOptionPane.ERROR_MESSAGE);
       }   
  ...
  total=quantity*price;
    ...
    private void jTextField8FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField8FocusLost
          ...
          payment=total-disAmount;
          jTextField9.setText(String.valueOf(payment));
