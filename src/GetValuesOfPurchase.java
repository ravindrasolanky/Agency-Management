 ...
 * @author w7
 */
public class GetValuesOfPurchase extends JFrame
{	
    /**
     * 
     * @param fieldname
     * @param fieldvalue
     */
    public GetValuesOfPurchase(String fieldname,String fieldvalue) 
	{
             setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
		Vector header=new Vector();//for table header
		Vector records=new Vector(); //for inner vector
		Connection con=DBinfo.getConn();
		String query="select * from purchase where "+fieldname+"=?";
		try
		{
